...
function ORZINF() {
    ...
    if(orzCount>=10000) {
        document.getElementById("mainarea").innerHTML="<h1 style=\"color:red\" align=\"center\">CKV:你这个辣鸡，怎么天天膜我？<br>我还要去PKU吊打集训队，还要去MIT秒题<br>（CKV说着走起了路准备离开）</h1><br><br><div id=\"walkckv\" align=\"center\"><img src=\"walkckv.gif\"/></div><br><button style=\"font-size: 24px\" onclick=\"last_orz()\" id=\"lastorz\">继续膜拜...</button>";
    }
}
